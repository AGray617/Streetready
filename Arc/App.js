  ...
  return (
    <div style={{ maxWidth: 660, margin: "0 auto", padding: "20px 14px 60px" }}>
      <div className="fade-up" style={{ background: "linear-gradient(135deg,#0d1428 0%,#1a1000 100%)", border: "1px solid #2a2010", borderLeft: "3px solid #c9a96e", borderRadius: 12, padding: "20px 18px", marginBottom: 16 }}>
        ...
        <div style={{ fontSize: 20, fontWeight: "bold", color: "#fff", marginBottom: 6, fontStyle: "italic" }}>Your Training Platform</div>
        <div style={{ fontSize: 13, color: "#7a6a4a", lineHeight: 1.7 }}>"Always be prepared to make a defense... with gentleness and respect." — 1 Peter 3:15</div>
      </div>
...
Conversation so far:
${history}`,
          messages: [{ role: "user", content: `The evangelist just said: "${input}"\n\nRespond as the objector then give coaching feedback.` }],
        })
      });
